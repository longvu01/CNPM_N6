<?php
    ...
    // $output.="</td>";
    $output.="<td>";
    $output.="<a href='/CNPM_N6/manage/update.php?id=".$item['ma']." '><i class='bx bx-edit-alt staff-button'></i></a>";
    $output.="<a href='/CNPM_N6/manage/delete.php?id=".$item['ma']."'><i class='bx bx-trash staff-button'></i></a>";
    $output.="</td>";   
    $output.="</tr>";
    }
    $output.="</tbody>";
